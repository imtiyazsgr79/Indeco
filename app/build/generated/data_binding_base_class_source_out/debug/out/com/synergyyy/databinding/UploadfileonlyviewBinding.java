...
public final class UploadfileonlyviewBinding implements ViewBinding {
  @NonNull
  ...
  private UploadfileonlyviewBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static UploadfileonlyviewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static UploadfileonlyviewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.uploadfileonlyview, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static UploadfileonlyviewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new UploadfileonlyviewBinding((ConstraintLayout) rootView, errormsgtv, innerLayout,
          pdfView, toolbarUploadPdf);
    }
