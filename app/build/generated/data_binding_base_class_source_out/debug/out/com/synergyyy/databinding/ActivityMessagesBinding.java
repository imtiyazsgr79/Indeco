...
public final class ActivityMessagesBinding implements ViewBinding {
  ...
  private ActivityMessagesBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView rvMessages,
  ...
  public static ActivityMessagesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.rv_messages;
      RecyclerView rvMessages = rootView.findViewById(id);
      if (rvMessages == null) {
        break missingId;
      }
      ...
      return new ActivityMessagesBinding((LinearLayout) rootView, rvMessages, toolbar);
    }
