...
public final class ActivityTaskSearchBinding implements ViewBinding {
  ...
  private ActivityTaskSearchBinding(@NonNull LinearLayout rootView, @NonNull ListView listView,
  ...
  @NonNull
  public static ActivityTaskSearchBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTaskSearchBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_task_search, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTaskSearchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTaskSearchBinding((LinearLayout) rootView, listView, scrollViewSearch,
