...
public final class QuoteSearchBinding implements ViewBinding {
  @NonNull
  ...
  private QuoteSearchBinding(@NonNull LinearLayout rootView, @NonNull ListView listView,
  ...
  @NonNull
  public static QuoteSearchBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static QuoteSearchBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.quote_search, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static QuoteSearchBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new QuoteSearchBinding((LinearLayout) rootView, listView, scrollViewSearch, searchView,
          toolSearch);
    }
