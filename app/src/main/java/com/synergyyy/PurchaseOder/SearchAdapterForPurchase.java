...
public class SearchAdapterForPurchase extends BaseAdapter {
    ...
    public SearchAdapterForPurchase(Context context, ArrayList<SearchResponse> items, String workspaceId, double latitude, double longitude) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context.getApplicationContext(), UploadPurchasePdf.class);
                intent.putExtra("frId", frid);
                intent.putExtra("token",to.getText().toString());
